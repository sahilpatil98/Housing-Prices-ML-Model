...
GEMFURY_URL= "https://hzYH8XS4QbE753aQgsyS@push.fury.io/sahilpatil98/"
...
python "setup.py" sdist bdist_wheel || die "Building package $PACKAGE_NAME failed"
PACKAGE_NAME=$(python "setup.py" --fullname)
